...
## Statistical Tests for Num Deps Shrinkage
...
```
So, `min_dep_analysis_tmp$NPM_MinDepsOldness` is statistically smaller!
...
## Main Results for Num Deps Shrinkage
...
```
So, `oldness_by_pkg_success_non_trivial$MinOldness` is statistically smaller!
...
## Statistical Tests for Slowdown
