...
```{r}
vanilla_sizes <- read_tsv("/home/donald/vanilla_sizes.tsv", col_names = c("Size", "Project"), show_col_types = FALSE) %>% drop_na()
min_deps_sizes <- read_tsv("/home/donald/npm_min_num_deps.tsv", col_names = c("Size", "Project"), show_col_types = FALSE) %>% drop_na()
min_oldness_sizes <- read_tsv("/home/donald/npm_min_oldness.tsv", col_names = c("Size", "Project"), show_col_types = FALSE) %>% drop_na()
min_duplicates_sizes <- read_tsv("/home/donald/npm_min_duplicates.tsv", col_names = c("Size", "Project"), show_col_types = FALSE) %>% drop_na()
...
write(
  str_c("\\newcommand{\\dataFSShrinkageQuartileFirst}{", 
        round(fs_shrinkage$Quantile25, digits=2),
        "}\n"),
  results_tex, append=TRUE)
