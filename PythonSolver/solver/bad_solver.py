...
from solver.base import Registry, Solver, WorldState
...
class BadSolver(Solver):
  def solve(self, previous_solution: Optional[SolutionTree], dependencies: List[Dependency], registry: Registry) -> SolutionTree:
    return SolutionTree([ResolvedPackage("a", SemverVersion(3, 2, 1), [ResolvedPackage("b", SemverVersion(2, 1, 2), [])]), ResolvedPackage("c", SemverVersion(1, 2, 3), [])])