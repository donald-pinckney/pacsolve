...
final class PackageManagersWork: XCTestCase {
    ...
    func resultAssertions(_ execResult: ExecutionResult<AnyHashable>) {
        let aVersion1Result = SolutionTree(children: [ResolvedPackage(package: "a", version: "0.0.1", data: 0 as AnyHashable, children: [])])
        let aVersion2Result = SolutionTree(children: [ResolvedPackage(package: "a", version: "0.0.2", data: 0 as AnyHashable, children: [])])
